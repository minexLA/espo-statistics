<div class="dashlet-content" style="padding: 14px 12px;">
    ...
    <div style="text-align:center; margin-bottom:14px;">
        <span style="display:inline-block; padding:4px 16px; background:#f0f4ff; border:1px solid #c5d3f0;
                     border-radius:20px; font-size:13px; color:#3366cc; font-weight:600;">
            <span class="glyphicon glyphicon-map-marker" style="margin-right:5px; font-size:11px;"></span>
            <span data-name="geo-label">—</span>
        </span>
    </div>
