...
```
(npm run sync; cd site; vendor/bin/phpunit tests/unit/Espo/Modules/Statistics)
```
...
```
(npm run sync; cd site; vendor/bin/phpunit tests/integration/Espo/Modules/Statistics)
```
...
If your extension contains additional PHP packages, you also need to add `site/custom/Espo/Modules/Statistics/vendor` to the *scanDirectories* section in *phpstan.neon* config.
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/Statistics`
* `site/tests/integration/Espo/Modules/Statistics`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/Statistics/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/Statistics/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/statistics/lib/init.js"
        ]
    }
    ```
...
Add the library module path to `src/files/custom/Espo/Modules/Statistics/Resources/metadata/app/jsLibs.json`

```json
{
    "some-lib": {
        "path": "client/custom/modules/statistics/lib/some-lib.js"
    }
}
```
